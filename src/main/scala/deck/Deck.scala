...
trait Deck {
  ...
  /** Draws a card from the deck.
    *
    *  @return A tuple containing the drawn card.cards.cards.Card and the resulting Deck.
    */
  ...
  /** Searches for a card by name in the deck.
    ...
    * @return An Option containing the card.cards.cards.Card if found, or None otherwise.
    */
